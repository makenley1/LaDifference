  ...
  <div class="container">
    <div class="row">
      <div class="col-6 col-lg-4">
        <h1><a href="{{'/'}} " class="notranslate"> MyHôtel</a><small>Guide des Hôtel Haitiens</small></h1>
      </div>
  ...
  <nav class="navbar navbar-expand-lg py-0 navbar-light">
    <div class="container">
      ...
      <div class="aa-input-container" id="aa-input-container">
        <input type="search" id="aa-search-input" class="aa-input-search" placeholder="Rechercher un ôtel" name="search" autocomplete="off" />
